...
Nothing here is applied yet. Items are labelled by section — A1, B3, D6 — and
that is how they are referred to in conversation.

One ambiguity to watch: **DCLS's own example sheets are also called C1, C2 and
C3.** Where this file says C1 it means the item below unless it says "example
sheet C1".
