...
- [ ] **E-stop fitted to the amplifier and tested.** Steve holds it throughout.
...
| What | Where |
|---|---|
| Deck | `slides/l01-course-introduction/index.md` |
| Handout | `docs/l01-course-introduction/index.md` |
| Run sheet | this file |
...
|---|---|---|---|
| 0 | 5 | Welcome. What the unit is, how the two halves fit, how a session runs (P17) and how today differs | Deck: unit map |
...
| 40 | 10 | **The hook,** and set the independent work | Deck |
...
| Running late at the 25-minute mark of hour 2 | Cut round 1 to two sets. Never cut the hook |
