...
| \(\omega_\mathrm{d}\) | Damped frequency, \(\omega_\mathrm{d} = \omega_\mathrm{n}\sqrt{1-\zeta^2}\) — the frequency a decaying oscillation actually runs at. | Informally **ringing**, which you will hear in a laboratory but rarely read in a textbook. |
