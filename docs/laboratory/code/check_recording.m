...
if ty(1) > 2*dt
    ...
    fprintf(2, ['  The beginning has been cut off. That is the scope''s\n' ...
                '  "Limit data points to last N" setting: turn it off, or the\n' ...
                '  step you are trying to fit is not in the file.\n']);
end
...
if hi - lo < 1e-6
    ...
    fprintf(2, ['\n  Three ways that happens:\n' ...
                ...
                '       run had finished.\n' ...
                '    3. The scope threw the beginning away, as above.\n'], lo);
    return
end
