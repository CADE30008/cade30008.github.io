---
title: "Lecture 2 solutions: PID control"
description: "Worked solutions to the Lecture 2 example sheet."
lesson: l02-pid-control
---

# Solutions: PID control
...
=== "Python"
    ...
    ```python
    --8<-- "l02-pid-control/code/q6_solution.py"
    ```

=== "MATLAB"

    ```matlab
    --8<-- "l02-pid-control/code/q6_solution.m"
    ```
