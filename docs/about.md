...
The numbers, plots and code all come from one design script per lecture. Every code snippet you see in MATLAB and Python has been run, and both languages give the same numbers.
