...
- Documents drafted with AI assistance, such as proposals, briefs, rubrics and process documents, carry a note in their front-page header saying so, with a footnote that final versions of all process and assignment documents, and of all student-facing and back-office code, will be fully checked manually. Keep the note when editing them, and add it to new ones.
